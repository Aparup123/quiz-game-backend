...
const getAttemptsSchema = z.object({
    quizTemplateId: z.string().min(1, "Quiz Template Id is required").describe("The ID of the quiz template to get attempts for"),
})
...
const evaluateAttemptSchema = z.object({  
    quizAttemptId: z.string().min(1, "Quiz Attempt Id is required").describe("The ID of the quiz attempt to evaluate"),
});
